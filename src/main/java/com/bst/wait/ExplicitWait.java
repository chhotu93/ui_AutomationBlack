...
public class ExplicitWait {
    ...
    public WebElement waitForElementToBePresent(By locator) {
        ...
        return waitFor((Function) ExpectedConditions.presenceOfElementLocated(locator));
    }
    ...
    public WebElement waitForElementToBeVisible(By locator, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        forPage();
        return waitFor((Function) ExpectedConditions.visibilityOfElementLocated(locator), timeOutInSeconds, pollingEveryInMiliSec);
    }
    ...
    public WebElement waitForElementToBeVisible(WebElement webElement, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        forPage();
        return waitFor((Function) ExpectedConditions.visibilityOf(webElement), timeOutInSeconds, pollingEveryInMiliSec);
    }
    ...
    public boolean waitForTextToBePresentInElementValue(WebElement element, String searchedText) {
        ...
        return waitFor((Function) ExpectedConditions.textToBePresentInElementValue(element, searchedText));
    }
    ...
    public WebElement waitForElementToBeClickable(WebElement element, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        forPage();
        return waitFor((Function) ExpectedConditions.elementToBeClickable(element), timeOutInSeconds, pollingEveryInMiliSec);
    }
    ...
    public boolean waitForInvisibilityOfElement(WebElement element, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        return waitFor((Function) ExpectedConditions.invisibilityOf(element), timeOutInSeconds, pollingEveryInMiliSec);
    }
    ...
    public boolean waitForInvisibilityOfElement(By locator, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        return waitFor((Function) ExpectedConditions.invisibilityOfElementLocated(locator), timeOutInSeconds, pollingEveryInMiliSec);
    }
    ...
    public boolean forPage(int timeoutInSeconds) {
        ...
        waitForInvisibilityOfElement(By.cssSelector("i.fa-spinner"),
                config.timeout().page, config.timeout().poolingInterval);
        waitForInvisibilityOfElement(By.cssSelector(".ag-overlay-loading-center"),
                config.timeout().page, config.timeout().poolingInterval);
        waitForInvisibilityOfElement(By.xpath("//*[@class='app-spinner']"),
                config.timeout().page, config.timeout().poolingInterval);
    ...
    public WebElement waitForElementExistAndVisible(By locator, int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        return (WebElement) waitFor((Function) ExpectedConditions.visibilityOfElementLocated(locator),
    ...
    public void waitForIframe(By locator, int timeOutInSeconds, int pollingEveryInMiliSec) {
        log.info(locator);
        waitFor((Function) ExpectedConditions.frameToBeAvailableAndSwitchToIt(locator),
                timeOutInSeconds, pollingEveryInMiliSec);
    ...
    public boolean waitForNewTab(int timeOutInSeconds, int pollingEveryInMiliSec) {
        ...
        return waitFor((Function) ExpectedConditions.numberOfWindowsToBe(2),
                timeOutInSeconds, pollingEveryInMiliSec);
    }
